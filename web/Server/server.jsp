...
<%@page import="Utility.ProductPojo"%>
...
/////////////////////////////////////////////////////////////////////////////////
    if (key.equals("payment")) {
        ...
        String str2 = "update payment set total_amount = '" + total + "',status='paid', station = '" + station + "', train = '" + train + "', coach = '" + coach + "', seat = '" + seat + "' , arriving_time = '"+arrival_time+"' where p_id='" + pay_id + "'";
...
String date = java.time.LocalDate.now().toString();
        ...
        if (itr1.hasNext()) {
            while (itr1.hasNext()) {
                ...
                bean.setStation_id(v.get(12).toString());
                bean.setRes_name(v.get(15).toString());
                bean.setPhone(v.get(19).toString());
                allInfos.add(bean);
                System.out.println(allInfos);
...
String date = java.time.LocalDate.now().toString();
        ...
        if (itr1.hasNext()) {
            while (itr1.hasNext()) {
                ...
                bean.setDelivery_status(v.get(10).toString());
                bean.setDeliveryboy(v.get(11).toString());
                bean.setUser_name(v.get(14).toString());
                bean.setPhone(v.get(17).toString());
                allInfos.add(bean);
                System.out.println(allInfos);
...
if (key.equals("user_travelling_detail")) {
    ...
    String str1 = "select p.coach , p.seat , s.name , t.name,p.arriving_time from payment p ,station s,train t where p.p_id ='" + p_id + "' and p.station = s.sid and p.train = t.tid  ";
    System.out.println(str1);
    String data = "",name ="", phone;
    int i = 1;
    ...
    if (itr1.hasNext()) {
        Vector v = (Vector) itr1.next();
       data = v.get(0).toString()+"#"+v.get(1).toString()+"#"+v.get(2).toString()+"#"+v.get(3).toString()+"#"+v.get(4).toString();
